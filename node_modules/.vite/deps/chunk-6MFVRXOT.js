...
import {
  I18n
} from "./chunk-JYRCREBY.js";
import {
  t as t2
} from "./chunk-2OEVU4YK.js";
import {
  ZodBoolean,
  ZodEffects,
  ZodNullable,
...
import {
  Skeleton
} from "./chunk-JH5UX5VP.js";
import {
  FilePreview
} from "./chunk-4LE5ZK27.js";
import {
  ConditionalTooltip
} from "./chunk-OZIVH22Q.js";
import {
  we
} from "./chunk-WRNH6XUK.js";
import {
  formatDistance
...
// node_modules/@medusajs/dashboard/dist/chunk-6ZPQG4RT.mjs
          ...
          children: [
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-list-ZE7FJ4LT-4PF2LWMW.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-create-JVV7ZQOA-ZASR3IOE.js")
                    },
                    {
                      path: "import",
                      lazy: () => import("./product-import-R7E7AX6R-OX5O2UI2.js")
                    },
                    {
                      path: "export",
                      lazy: () => import("./product-export-S544QXRJ-XNS53WYI.js")
                    }
                  ]
                },
                {
                  ...
                  errorElement: (0, import_jsx_runtime18.jsx)(ErrorBoundary, {}),
                  lazy: async () => {
                    const { Breadcrumb, loader } = await import("./product-detail-HBFJISYZ-BIDLQPQL.js");
                    return {
                      Component: Outlet,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./product-detail-HBFJISYZ-BIDLQPQL.js"),
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./product-edit-CVYOZK46-2HMXQQM3.js")
                        },
                        {
                          path: "edit-variant",
                          lazy: () => import("./product-variant-edit-IAJODIBN-5FO73NFM.js")
                        },
                        {
                          path: "sales-channels",
                          lazy: () => import("./product-sales-channels-DCQOHEYB-ZLDKUYQN.js")
                        },
                        {
                          path: "attributes",
                          lazy: () => import("./product-attributes-6KJUE6GG-ELB53JVI.js")
                        },
                        {
                          path: "organization",
                          lazy: () => import("./product-organization-PKZJ74EN-QOBE3MMQ.js")
                        },
                        {
                          path: "shipping-profile",
                          lazy: () => import("./product-shipping-profile-FA3UAU7A-LI6JW4XN.js")
                        },
                        {
                          path: "media",
                          lazy: () => import("./product-media-KHBER6UE-5LOP2FX2.js")
                        },
                        {
                          path: "prices",
                          lazy: () => import("./product-prices-6GQXKVKM-VGQUN5MO.js")
                        },
                        {
                          path: "options/create",
                          lazy: () => import("./product-create-option-XBN5ESJQ-3WHXDRXJ.js")
                        },
                        {
                          path: "options/:option_id/edit",
                          lazy: () => import("./product-edit-option-EPX6OM35-CKNQFDNR.js")
                        },
                        {
                          path: "variants/create",
                          lazy: () => import("./product-create-variant-LMM7MCLY-6CUU5UF7.js")
                        },
                        {
                          path: "stock",
                          lazy: () => import("./product-stock-3RDIBMGD-UZATGFIS.js")
                        },
                        {
                          path: "metadata/edit",
                          lazy: () => import("./product-metadata-PTNUGYZW-EWVATEV2.js")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component: Component4, Breadcrumb, loader } = await import("./product-variant-detail-CJDRLDMN-OMVNBI74.js");
                        return {
                      ...
                      children: [
                        ...
                        {
                          path: "manage-items",
                          lazy: () => import("./product-variant-manage-inventory-items-XJEJW35P-QJYE4DLR.js")
                        },
                        {
                          path: "metadata/edit",
                          lazy: () => import("./product-variant-metadata-2RKINR5L-UWE67BU7.js")
                        }
                      ]
                    }
                  ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./category-list-4LUZATDD-B6TEQGYG.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./category-create-OL37ATOA-BX56QQTQ.js")
                    },
                    {
                      path: "organize",
                      lazy: () => import("./category-organize-MZUOSX6P-R34EQB6E.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./category-detail-JHSAREY7-X4EKHVCJ.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./category-edit-CPUTD66C-PZZ7LRG6.js")
                    },
                    {
                      path: "products",
                      lazy: () => import("./category-products-7VQCC5U3-H7I73ISX.js")
                    },
                    {
                      path: "organize",
                      lazy: () => import("./category-organize-MZUOSX6P-R34EQB6E.js")
                    ...
                    {
                      path: "metadata/edit",
                      lazy: () => import("./categories-metadata-W2CESHV5-N3IRXUVX.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./order-list-XZ4KYLON-RQTWN6DR.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./order-detail-ZD3S536D-AUW7UWVR.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "fulfillment",
                      lazy: () => import("./order-create-fulfillment-ZO4M5SNQ-D5ISTDO4.js")
                    },
                    {
                      path: "returns/:return_id/receive",
                      lazy: () => import("./order-receive-return-YAYMPZJW-A5EOLSZD.js")
                    },
                    {
                      path: "allocate-items",
                      lazy: () => import("./order-allocate-items-TD4OOYWA-3Y5L4FXJ.js")
                    },
                    {
                      path: ":f_id/create-shipment",
                      lazy: () => import("./order-create-shipment-XRXASEDU-AR7WNK5X.js")
                    },
                    {
                      path: "returns",
                      lazy: () => import("./order-create-return-4T4DXNP7-RQ4ZB6CE.js")
                    },
                    {
                      path: "claims",
                      lazy: () => import("./order-create-claim-T2FBEXOQ-5HVPD2JP.js")
                    },
                    {
                      path: "exchanges",
                      lazy: () => import("./order-create-exchange-AEMOZGTG-2D6OQHCT.js")
                    },
                    {
                      path: "edits",
                      lazy: () => import("./order-create-edit-EWYEFSHV-LLXHDTR6.js")
                    },
                    {
                      path: "refund",
                      lazy: () => import("./order-create-refund-I7ZZWLFJ-2XLJUIDK.js")
                    },
                    {
                      path: "transfer",
                      lazy: () => import("./order-request-transfer-CNXHL2ZY-FJFIONTJ.js")
                    },
                    {
                      path: "email",
                      lazy: () => import("./order-edit-email-ICL7BC2B-UMBOPIT3.js")
                    },
                    {
                      path: "shipping-address",
                      lazy: () => import("./order-edit-shipping-address-7XUKNU22-442EXJAR.js")
                    },
                    {
                      path: "billing-address",
                      lazy: () => import("./order-edit-billing-address-NPP6ZOAE-AQRWCH3V.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./order-metadata-MWSSDBMQ-EVGQQVLT.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./promotion-list-WS74DGAU-BMC6GVVZ.js")
                },
                {
                  path: "create",
                  lazy: () => import("./promotion-create-HYNZCKXP-YLEDJFOE.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./promotion-detail-ME7L4QFX-UTROF2R4.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./promotion-edit-details-YICY5ZJL-XHSVCX26.js")
                    },
                    {
                      path: "add-to-campaign",
                      lazy: () => import("./promotion-add-campaign-4MRPKION-A5OB74CO.js")
                    },
                    {
                      path: ":ruleType/edit",
                      lazy: () => import("./edit-rules-WWTN2XK2-T5VE52AU.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./campaign-list-2L43M6VK-ED6QIYNG.js"),
                  children: []
                },
                {
                  path: "create",
                  lazy: () => import("./campaign-create-AOJJFFCT-KSXH4UWF.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./campaign-detail-VPVCGALN-HJJCKJ6F.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./campaign-edit-TY5I5ZMS-D46PVF5O.js")
                    },
                    {
                      path: "configuration",
                      lazy: () => import("./campaign-configuration-T7U7VQ63-W423IMVB.js")
                    },
                    {
                      path: "edit-budget",
                      lazy: () => import("./campaign-budget-edit-XG46WNQN-5WSP3RBM.js")
                    },
                    {
                      path: "add-promotions",
                      lazy: () => import("./add-campaign-promotions-IEUNRQLL-5G5MOCST.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./collection-list-4G6V343G-LLMVFHBU.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./collection-create-BWDX2T4L-7OLJIRFB.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./collection-detail-SFZDN2RS-NOSQSUZQ.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./collection-edit-2ZP3IMAP-5YEQ5USY.js")
                    },
                    {
                      path: "products",
                      lazy: () => import("./collection-add-products-LVH7EYET-FGWHPUWS.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./collection-metadata-VADZZZ7U-BGFN6EOP.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./price-list-list-SN5U2FL3-N3RKHGDV.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./price-list-create-LT4D6HY3-7RXEILVZ.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./price-list-detail-76BYWE7A-ANH5L57H.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./price-list-edit-LTN23QHD-ASXKOT3H.js")
                    },
                    {
                      path: "configuration",
                      lazy: () => import("./price-list-configuration-5Q6DGDYH-SHUGVIIZ.js")
                    },
                    {
                      path: "products/add",
                      lazy: () => import("./price-list-prices-add-44A6F6W6-FXCD23FX.js")
                    },
                    {
                      path: "products/edit",
                      lazy: () => import("./price-list-prices-edit-ADO2CCEW-FC2SRXMV.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./customer-list-KYO4ZLSU-ZKXPLSUO.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./customer-create-BIM4YFGV-4SMYRE3A.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./customer-detail-VBMZUWKA-W7LWHQQ6.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./customer-edit-FJNPYFCK-LNMKNFYU.js")
                    },
                    {
                      path: "create-address",
                      lazy: () => import("./customer-create-address-TPSDYZBN-NPTOFRRE.js")
                    },
                    {
                      path: "add-customer-groups",
                      lazy: () => import("./customers-add-customer-group-NPJWG37O-RSAWVT5L.js")
                    },
                    {
                    ...
                    {
                      path: "metadata/edit",
                      lazy: () => import("./customer-metadata-5NPUMPZ2-HILTFRKU.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./customer-group-list-CXR5US56-4OTMZXGW.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./customer-group-create-7X4TZR54-BBVXDDNA.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./customer-group-detail-LFS6WFVS-FACCXIPN.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./customer-group-edit-J3AGQAAF-TOKCMNNK.js")
                    },
                    {
                      path: "add-customers",
                      lazy: () => import("./customer-group-add-customers-Q6DGE5DV-QO63NGWC.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./customer-group-metadata-UPAPULMF-2ICROXMB.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./reservation-list-7MX4KHR7-GO5ZSXCS.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./reservation-create-XIYRCMCL-6RI74QXN.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./reservation-detail-ZRLQZHKV-IAQMWVLD.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./edit-reservation-OEYCFX5G-UM65327J.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./reservation-metadata-2IEGRN5N-5XGMISL5.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./inventory-list-AI6CCLQQ-4OE4FX3W.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./inventory-create-DR5CTETM-WHUQ4PZT.js")
                    },
                    {
                      path: "stock",
                      lazy: () => import("./inventory-stock-Y3BLFXTS-ID5FQDEX.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./inventory-detail-5T25FK54-4SFRTDQE.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./edit-inventory-item-C5LOBVNU-NKZNH4NN.js")
                    },
                    {
                      path: "attributes",
                      lazy: () => import("./edit-inventory-item-attributes-3PFNDKPM-I46BFNFQ.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./inventory-metadata-E5XGI7DQ-U6ZUP4XG.js")
                    },
                    {
                      path: "locations",
                      lazy: () => import("./manage-locations-PIPXIO4Z-JGOSMFW3.js")
                    },
                    {
                      path: "locations/:location_id",
                      lazy: () => import("./adjust-inventory-FL2YMCXV-KA6GHW5W.js")
                    }
                  ]
                }
              ]
      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              path: "profile",
              errorElement: (0, import_jsx_runtime18.jsx)(ErrorBoundary, {}),
              lazy: () => import("./profile-detail-ROG22HHL-XQIHWKN4.js"),
              handle: {
              ...
              children: [
                {
                  path: "edit",
                  lazy: () => import("./profile-edit-HSUQIQQH-633Q2AQN.js")
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./region-list-2YVIIJSN-WPO4QROX.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./region-create-PV3IW352-3BJJNHWZ.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./region-detail-UGQRJJHW-CVPEXTVT.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./region-edit-MMNZ7YFU-PD4BD6SA.js")
                    },
                    {
                      path: "countries/add",
                      lazy: () => import("./region-add-countries-M7O3RG2T-2DHNSEJA.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./region-metadata-AHFTUQ6R-PWDN3O7H.js")
                    }
                  ]
                }
              ]
            },
            {
              path: "store",
              errorElement: (0, import_jsx_runtime18.jsx)(ErrorBoundary, {}),
              lazy: () => import("./store-detail-575XDHHQ-AZGRSYHS.js"),
              handle: {
              ...
              children: [
                {
                  path: "edit",
                  lazy: () => import("./store-edit-HY5BXMVX-CVBMM5Y6.js")
                },
                {
                  path: "currencies",
                  lazy: () => import("./store-add-currencies-ETHNDZOX-L5A6RMNM.js")
                },
                {
                  path: "metadata/edit",
                  lazy: () => import("./store-metadata-5Z3XHK3E-QYMWZTYR.js")
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./user-list-PIQLQBQE-IJPBSLOK.js"),
                  children: [
                    {
                      path: "invite",
                      lazy: () => import("./user-invite-MGQKN5D3-A3WYBFDV.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./user-detail-IJFMKM7T-33VSUPY5.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./user-edit-XTVRRK7B-MQT5SHCL.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./user-metadata-FGYJOHB6-EM6YZIYM.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./sales-channel-list-WH42O7JA-OQM3CE3V.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./sales-channel-create-N3WMJXT7-EH2TURZZ.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./sales-channel-detail-XVJIBVR3-EQUAUPV6.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./sales-channel-edit-F5MHMFG3-R3IGXBT4.js")
                    },
                    {
                      path: "add-products",
                      lazy: () => import("./sales-channel-add-products-72JBKLD7-36D4QLOB.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./sales-channel-metadata-XUOVWE2X-DF6IAMFF.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./location-list-M4RYGH65-ZDDB77QE.js")
                },
                {
                  path: "create",
                  lazy: () => import("./location-create-LUP363ZB-A7BKWUQU.js")
                },
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./shipping-profiles-list-AUB5F6SI-AUIYJZUF.js"),
                      children: [
                        {
                          path: "create",
                          lazy: () => import("./shipping-profile-create-KRMI6NUI-UF2U4IHP.js")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component: Component4, Breadcrumb, loader } = await import("./shipping-profile-detail-FDUPDSH4-AIY3O7OU.js");
                        return {
                          Component: Component4,
                          loader,
                          handle: {
                      ...
                      children: [
                        {
                          path: "metadata/edit",
                          lazy: () => import("./shipping-profile-metadata-G47QVZOP-YJBLUXQ4.js")
                        }
                      ]
                    }
                  ]
                },
                {
                  path: ":location_id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./location-detail-3U4AJNOY-MXEJC2X5.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./location-edit-26K26G23-EWQF4FS7.js")
                    },
                    {
                      path: "sales-channels",
                      lazy: () => import("./location-sales-channels-EVHL5OEB-2D7HPN7K.js")
                    },
                    {
                      path: "fulfillment-providers",
                      lazy: () => import("./location-fulfillment-providers-O277BKVF-VXPRRYUN.js")
                    },
                    {
                      ...
                      children: [
                        {
                          ...
                          lazy: () => import("./location-service-zone-create-6ASVPJ2T-FYW2LJQY.js")
                        },
                        {
                          ...
                          children: [
                            {
                              path: "edit",
                              lazy: () => import("./location-service-zone-edit-74Q2BX26-Z6CQRWSE.js")
                            },
                            {
                              path: "areas",
                              lazy: () => import("./location-service-zone-manage-areas-QMHNHHF6-YTBKTHYU.js")
                            },
                            {
                              ...
                              children: [
                                {
                                  path: "create",
                                  lazy: () => import("./location-service-zone-shipping-option-create-TEMRUOLU-BYSL7BIQ.js")
                                },
                                {
                                  path: ":so_id",
                                  children: [
                                    {
                                      path: "edit",
                                      lazy: () => import("./location-service-zone-shipping-option-edit-PV7BGNGF-U6TJMSXF.js")
                                    },
                                    {
                                      path: "pricing",
                                      lazy: () => import("./location-service-zone-shipping-option-pricing-5BAXQBBI-BSPYVV4K.js")
                                    }
                                  ]
                                }
                              ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-tag-list-BQ2OY3AV-URXOQOYE.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-tag-create-KPEJXZ2Q-H4XUNV5R.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./product-tag-detail-YOKAKUZS-TMTH2PVM.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./product-tag-edit-DEWTW4YF-5K43T7L7.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./workflow-execution-list-WRCFDBSW-ZBFBPXOH.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./workflow-execution-detail-T7Z32I2I-EMRXQWKY.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-type-list-JM6AFTWL-Q7FVD7M3.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-type-create-VXEOY6IV-32BGCHXP.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./product-type-detail-ZZWOVXLS-DVNHAHVA.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./product-type-edit-EOBA5GJ3-5DM4L7TQ.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./product-type-metadata-5YQNX7RR-DQ4OVXDH.js")
                    }
                  ]
                }
              ]
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./api-key-management-list-GJWJDTNJ-B7GIUWEE.js"),
                      children: [
                        {
                          path: "create",
                          lazy: () => import("./api-key-management-create-CMDHXLLL-ARURLSHC.js")
                        }
                      ]
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./api-key-management-detail-QDITLDDQ-SIVUSVHK.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./api-key-management-edit-55YWPC5T-IGLNN72G.js")
                    },
                    {
                      path: "sales-channels",
                      lazy: () => import("./api-key-management-sales-channels-JV2Q2NR2-DSTJHWKB.js")
                    }
                  ]
                }
              ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./tax-region-list-WLTMUWAT-FWSKWDW2.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./tax-region-create-27U7XRGU-ST7M3TR5.js")
                    }
                  ]
                },
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: async () => {
                        const { Component: Component4 } = await import("./tax-region-detail-WCYWAVKW-UG5NX6UL.js");
                        return {
                          Component: Component4
                        };
                      },
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./tax-region-edit-TWPGKM4L-CQ3D3KVL.js")
                        },
                        {
                          path: "provinces/create",
                          lazy: () => import("./tax-region-province-create-FFXYN7M4-HW4P5L7Y.js")
                        },
                        {
                          path: "overrides/create",
                          lazy: () => import("./tax-region-tax-override-create-K2VQJ6OH-6C6SRQ52.js")
                        },
                        {
                          path: "overrides/:tax_rate_id/edit",
                          lazy: () => import("./tax-region-tax-override-edit-5IJ7WH7L-WRAWGZ4U.js")
                        },
                        {
                          path: "tax-rates/create",
                          lazy: () => import("./tax-region-tax-rate-create-T2FKYRNI-ZH6GVOZP.js")
                        },
                        {
                          path: "tax-rates/:tax_rate_id/edit",
                          lazy: () => import("./tax-region-tax-rate-edit-VACYUP6R-7SVOQOFP.js")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component: Component4, Breadcrumb, loader } = await import("./tax-region-province-detail-6X46BRIN-2DK7E2ZK.js");
                        return {
                          Component: Component4,
                          loader,
                          handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./return-reason-list-2SJ6WMWT-2YB5IPWY.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./return-reason-create-TFLUQVJH-3GD4OAIC.js")
                    },
                    {
                      path: ":id",
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./return-reason-edit-WN3KGPRR-WVKZ5RZ3.js")
                        }
                      ]
                    }
                  ]
      ...
      children: [
        {
          ...
          children: [
            {
              path: "/login",
              lazy: () => import("./login-7WGNCEWP-3PBLGMGI.js")
            },
            {
              path: "/reset-password",
              lazy: () => import("./reset-password-LHHZBHSH-TMLOIYZE.js")
            },
            {
              path: "/invite",
              lazy: () => import("./invite-IQITJV62-JPU72BQK.js")
            },
            {
              path: "*",
              lazy: () => import("./no-match-KSAPNRPO-UHA73HTZ.js")
            }
          ]
        }
      ]
...
//# sourceMappingURL=chunk-6MFVRXOT.js.map
